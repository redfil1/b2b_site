...
// Статические маршруты с реально существующими страницами. `/services` пока не
// добавлен — роут ещё не реализован (в Header ссылка есть, страницы нет), добавить
// сюда одной строкой, когда появится. `/search` не включаем осознанно: это
// страница результатов по query-параметру, в карте сайта смысла не несёт.
const STATIC_PATHS = [
  "/",
  "/catalog",
  "/company",
