    ...
    <div className="mt-8 flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-2">
        ...
        {/* Видимая строка с адресом менеджера (Frontend.md, раздел 7.4) — страховка на
            случай, если пункт меню не сработал или нужного сервиса в списке нет. Плюс
            ожидание ответа (раздел 8.11) — в потоке без подтверждения отправки снимает
            вопрос «дошло ли и когда ответят». */}
        <p className="text-sm text-secondary">
          Письмо уходит на{" "}
          <span className="font-medium text-primary">{siteConfig.contacts.email}</span>. Менеджер
          отвечает в течение 1 рабочего дня.
        </p>
