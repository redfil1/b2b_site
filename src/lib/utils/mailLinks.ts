...
//
// Форматы `yandexHref` и `mailruHref` проверены пользователем на живых сессиях 2026-09-07
// (`to`/`subject`/`body` и кириллица подставляются) — Frontend.md, раздел 7.4.
// Gmail/Outlook проверены ранее.
