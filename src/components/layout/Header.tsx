      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-4 md:gap-4 md:px-6 lg:px-8">
        ...
        <div className="flex shrink-0 items-center gap-3">
          ...
          >
            ...
            {count > 0 && (
              // Бейдж уменьшен и посажен ближе к иконке (было -top-1 -right-1, h-5,
              // text-xs) — на мобильном крупный бейдж почти касался кнопки-гамбургера
              // (скрины реального телефона, 2026-09-07).
              <span
                aria-hidden="true"
                className="absolute -top-0.5 -right-0.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-accent-amber px-1 text-[10px] font-semibold text-white"
              >
                {count}
              </span>
            )}
